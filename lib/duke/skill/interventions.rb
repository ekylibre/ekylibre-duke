    ...
    class Interventions
      ...
      def handle_parse_sentence params
        ...
        if dukeInt.ok_procedure? 
          ...
          dukeInt.to_ibm(modifiable: dukeInt.modification_candidates, moreable: dukeInt.complement_candidates)
        else
          dukeInt.guide_to_procedure # help user find his procedure if current_proc is not accepted
        end
      end 
